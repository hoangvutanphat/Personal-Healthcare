...
const CheckBMI = () => {
  ...
  const onFinish = async () => {
    ...
    const BMI = +(
      Math.round(
        WEIGHT.replace(/,/g, ".") / (valueHeight * valueHeight) + "e+2"
      ) + "e-2"
    );
    if (
      HEIGHT === undefined ||
  ...
  useEffect(() => {
    ...
    if (valueHeight && valueWeight && valueHeight >= 50) {
      ...
      const BMI = +(
        Math.round(
          valueWeight.replace(/,/g, ".") / (valueHeight1 * valueHeight1) + "e+2"
        ) + "e-2"
      );
      setValueBMI(BMI);
    }
        ...
        >
          {valueBMI > 0 && valueBMI < 18.5 ? (
            ...
            >
              ...
              <p>
                Chỉ số BMI của bạn đang thuộc khoảng thiếu cân, hãy thay đổi chế
                độ và luyện tập thể dục để cải thiện nhé
              </p>
            </div>
          ) : (
            ""
          ...
          {valueBMI >= 18.5 && valueBMI < 23 ? (
            ...
            >
              ...
              <p>
                Chỉ số BMI của bạn khá cân đối. Hãy giữ vững phong độ như thế
                nhé
              </p>
            </div>
          ) : (
          ...
          {valueBMI >= 25 && valueBMI < 30 ? (
            ...
            >
              ...
              <p>
                Chỉ số BMI của bạn đang thuộc khoảng tiền béo phì độ I, hãy thay
                đổi chế độ và luyện tập thể dục để cải thiện nhé
              </p>
            </div>
          ) : (
            ""
          ...
          {valueBMI > 30 ? (
            ...
            >
              ...
              <p>
                Chỉ số BMI của bạn đang thuộc khoảng tiền béo phì độ II, hãy
                thay đổi chế độ và luyện tập thể dục để cải thiện nhé
              </p>
            </div>
          ) : (
            ""
